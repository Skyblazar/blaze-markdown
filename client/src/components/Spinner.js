    ...
    <div style={{
      ...
      <svg className="spinner" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 595.44 595.44">
        ...
        <g id="Group_1" data-name="Group 1" transform="translate(-202.28 -202.28)">
          <path id="bottom" d="M500,202.28c-164.43,0-297.72,133.29-297.72,297.72S335.57,797.72,500,797.72,797.72,664.43,797.72,500,664.43,202.28,500,202.28Zm0,515.84c-120.47,0-218.12-97.65-218.12-218.12S379.53,281.88,500,281.88,718.12,379.53,718.12,500,620.47,718.12,500,718.12Z" fill="#fff" />
